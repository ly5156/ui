...
export default Component.extend(NewOrEdit, {
  ...
  willSave() {
    ...
    if (get(this, 'pasteOrUpload')) {
      ...
      const {
        outputFlushInterval, outputTags, dockerRoot, includeSystemComponent, enableMultiLineFilter, multiLineStartRegexp, multiLineEndRegexp
      ...
      const enableMultiLineFilter = get(model, `${ targetType }.enableMultiLineFilter`)
