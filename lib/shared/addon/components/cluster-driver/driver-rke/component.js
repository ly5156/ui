...
export default InputTextFile.extend(ManageLabels, ClusterDriver, {
  ...
  willSave() {
    ...
    if (ok) {
      ...
      // set gpu sharing
      if (get(this, 'enableGPUSharing')) {
        set(this, 'cluster.enableGPUManagement', true);
        ...
        set(this, 'cluster.enableGPUManagement', false);
        const services = get(this, 'cluster.rancherKubernetesEngineConfig.services') || {};
        const scheduler = services.scheduler || {};
  ...
  initNonTemplateCluster() {
    ...
    scheduleOnce('afterRender', () => {
      ...
      if (get(this, 'cluster.enableGPUManagement')) {
        setProperties(this, {
          gpuNodePort:      annotations['gpuschedulerport.cattle.io'] || 32666,
