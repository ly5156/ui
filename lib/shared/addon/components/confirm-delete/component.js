...
export default Component.extend(ModalBase, {
  ...
  isWorkload: computed('resources', function() {
    return !!get(this, 'resources').findBy('type', 'deployment') || !!get(this, 'resources').findBy('type', 'ingress') || !!get(this, 'resources').findBy('type', 'persistentVolumeClaim') || !!get(this, 'resources').findBy('type', 'service');
  }),
