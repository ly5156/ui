...
export default Controller.extend({
  ...
  hasProjectAdminRole: computed('model.currentUser', 'model.currentUserRoleId', function() {
    return get(this, 'model.currentUser.has_project_admin_role') || get(this, 'model.currentUserRoleId') === 1;
  }),
});