...
export default Component.extend({
  ...
  labelStyle:  computed('model.color', function() {
    ...
    return htmlSafe(`max-width:300px;font-size:12px;display:inline-block;padding:0 6px;border-radius: 6px;border:${ border };background-color:${ color }; color:${ font && font.textColor }`);
  }),
