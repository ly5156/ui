...
export default Component.extend({
  ...
  labelStyle:  computed('model.color', function() {
    ...
    return htmlSafe(`max-width:300px;display: inline-block;padding:0 6px 1px;border-radius: 6px;border:${ border };background-color:${ color }; color:${ font && font.textColor }`);
  }),
});
