...
export default Component.extend({
  ...
  labels: computed('model.labels', function() {
    ...
    return labels.map((label) => {
      ...
      return {
        cssStyle: htmlSafe(`max-width:300px;display:inline-block;padding:0 6px 1px;border-radius: 6px;border:${ border };background-color:${ color }; color:${ font && font.textColor }`),
        name:     label.name
      };
    });
  }),
