...
export default Component.extend({
  ...
  genLabelStyle(color) {
    ...
    return htmlSafe(`max-width:300px;display:inline-block;padding:0 6px 1px;border-radius: 6px;margin: 4px 4px;border:${ border };background-color:${ color }; color:${ font && font.textColor }`);
  },
  submit(event) {
